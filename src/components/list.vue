				...
				<div class="col-10">
					...
					<table class="table table-hover">
						...
						<tbody class="text-center">
							<tr v-for="studentInfos in studentInfo" :key="studentInfos">
								<td>
									<input
	...
	data() {
		return {
			studentInfo: [
				{
					date: "15/02/2021",
					requestform_name: "Request Form for Re-entering Student",
					student_name: "Thirawit Jirarungroj",
					student_id: 6131305010,
					school: "IT",
					form_status: "New Request",
					admission_acadamic_year: "2018",
					semester: 1,
				},
				{
					date: "12/02/2021",
					requestform_name: "Aequest Form for Re-entering Student",
					student_name: "Panjapon Thongkerd",
					student_id: 6131305016,
					school: "AT",
					form_status: "New Request",
					admission_acadamic_year: "2021",
					semester: 2,
				},
			],
		};
